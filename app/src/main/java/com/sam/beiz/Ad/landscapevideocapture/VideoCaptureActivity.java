...
package com.sam.beiz.Ad.landscapevideocapture;
...
import com.sam.beiz.Ad.landscapevideocapture.camera.CameraWrapper;
import com.sam.beiz.Ad.landscapevideocapture.camera.NativeCamera;
import com.sam.beiz.Ad.landscapevideocapture.configuration.CaptureConfiguration;
import com.sam.beiz.Ad.landscapevideocapture.recorder.AlreadyUsedException;
import com.sam.beiz.Ad.landscapevideocapture.recorder.VideoRecorder;
import com.sam.beiz.Ad.landscapevideocapture.recorder.VideoRecorderInterface;
import com.sam.beiz.Ad.landscapevideocapture.view.RecordingButtonInterface;
import com.sam.beiz.Ad.landscapevideocapture.view.VideoCaptureView;
...
public class VideoCaptureActivity extends Activity implements RecordingButtonInterface, VideoRecorderInterface {
    ...
    public static final String EXTRA_OUTPUT_FILENAME = "com.sam.beiz.extraoutputfilename";
    public static final String EXTRA_CAPTURE_CONFIGURATION = "com.sam.beiz.extracaptureconfiguration";
    public static final String EXTRA_ERROR_MESSAGE = "com.sam.beiz.extraerrormessage";

    private static final String EXTRA_FRONTFACINGCAMERASELECTED = "com.sam.beiz.extracamerafacing";
    private static final String SAVED_RECORDED_BOOLEAN = "com.sam.beiz.savedrecordedboolean";
    protected static final String SAVED_OUTPUT_FILENAME = "com.sam.beiz.savedoutputfilename";
