package com.sam.beiz.Calendar.vo;
...
public class ScheduleVO implements Serializable {
	...
	public ScheduleVO(int scheduleID, int scheduleTypeID, int remindID, String scheduleContent, String scheduleDate, String time, Long alartime,String type){
