...
public class PreActivity extends Activity {
    ...
    public static String mVersionName = "1.4.6";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (login) {
            ...
            if (mainPref.getInt("accountType", 0) == 0) {
                intent = new Intent(PreActivity.this, UserView.class);
            } else if (mainPref.getInt("accountType", 0) == 1) {
                intent = new Intent(PreActivity.this, DistributorView.class);
            } else if (mainPref.getInt("accountType", 0) == 2) {
                intent = new Intent(PreActivity.this, OverlayDemo.class);
            }
            if (intent != null) {
                intent.putExtra("userPhone", account);
            } else {
                intent = new Intent(PreActivity.this, Login_main.class);
            }
            startActivity(intent);
        } else {
            Intent intent = new Intent(PreActivity.this, Login_main.class);
            startActivity(intent);
        }
        finish();
    }
