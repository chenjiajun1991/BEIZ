...
public class OverlayDemo extends ActionBarActivity {
	...
	public static List<BtySaleInfo> mBtySaleInfoList=null;
	...
	private  String mQuerySaleInfoUrl = null;
	...
	public static String jsonSaleInfo = null;
...
//			"关于",
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		textView.setText("生产厂家视图");
		btnBack.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent =new Intent(OverlayDemo.this,LauncherAcitivity.class);
...
//				null).execute(updateUrl);
		...
		mQuerySaleInfoUrl=Login_main.preUrl+"/bty/saleinfo.json";
...
//		updateInfo();
		...
		if(mBtySaleInfoList==null){
			mBtySaleInfoList=new ArrayList<BtySaleInfo>();
		}
		...
		if (mGetDisInfoReceiver == null) {
			...
			filter.addAction(Login_main.ACTION_QUERY_SALE_INFO);
...
//		distributorInfo=new DistributorInfo();
//		distributorInfo.latitude=34.756607+"";
//		distributorInfo.longitude=113.64964+"";
//		distributorInfo.resellerName="臧长见";
//		distributorInfo.resellerAddress="京沙亚龙电动车自行车批发市场";
//		distributorInfo.resellerPhone="18103713980";
//		distributorInfo.resellerProvince="河南";
//		distributorInfo.resellerCity="郑州";
//		distributorInfo.provinceId=12;
//		mDatabaseHandler.updateDisInfoForDb(distributorInfo);
//	}
...
//								break;
							case 3:
								...
								mCurDisCount = 0;
								mPageOffset = 1;
								Intent intent4 = new Intent(OverlayDemo.this, Login_main.class);
	...
	class GetDisInfoReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			}else if(intent.getAction().equals(Login_main.ACTION_QUERY_SALE_INFO)){
				String msg = null;
				if (intent.getBooleanExtra("getSaleInfoSuccess", false)) {
					dismissProgressDialog();
					Log.i("query",jsonSaleInfo);
					try {
						JSONObject jsonObject = new JSONObject(jsonSaleInfo);
						JSONObject jObect1 = jsonObject.getJSONObject("data");
						JSONArray jsonArray = jObect1.getJSONArray("btySaleInfos");
						List<BtySaleInfo> tempList=new ArrayList<BtySaleInfo>();
						for(int i=0;i<jsonArray.length();i++){
							JSONObject temp= (JSONObject) jsonArray.get(i);
							BtySaleInfo btySaleInfo=new BtySaleInfo();
							btySaleInfo.btyImei=temp.getString("btyImei");
							btySaleInfo.btySimNo=temp.getString("btySimNo");
							btySaleInfo.btySn=temp.getString("btySn");
							btySaleInfo.userName=temp.getString("userName");
							btySaleInfo.userphone=temp.getString("userphone");
							btySaleInfo.resellerName=temp.getString("resellerName");
							btySaleInfo.resellerPhone=temp.getString("resellerPhone");
							btySaleInfo.saleDate=temp.getString("saleDate");
							tempList.add(btySaleInfo);
                        }
						mBtySaleInfoList=tempList;
						if(mBtySaleInfoList.size()==0){
							AlertDialogShow("今天暂无销售记录！");
							return;
						}else {
							Intent intent2 = new Intent(OverlayDemo.this,
									DistributorInfoList.class);
	...
	public void querySaleInfo(){
		...
		new TestNetworkAsyncTask(OverlayDemo.this,
				TestNetworkAsyncTask.TYPE_QUERY_SALE_INFO,
				bundle).execute(mQuerySaleInfoUrl);
		ensureDialog();
	...
	private void ensureDialog() {
		if (dialog == null) {
			...
			dialog = ProgressDialog.show(OverlayDemo.this, null, msg, true, true);
	...
	public static class BtySaleInfo{
		BtySaleInfo(){}
		public String btyImei;
		public String btySimNo;
		public String btySn;
